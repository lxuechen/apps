...
### lxuechen: Using
- put data in the folder `~/data/apps` (this is also data root).
- generate paths by running `python train/apps_create_split.py`.
- from `train/` run `python -m dataset_apps.APPSBaseDataset`.
